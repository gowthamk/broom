...
\newcommand{\regionDeltaMap}{{\Delta_1}}
\newcommand{\predDeltaMap}{{\Delta_2}}
...
\newcommand{\emptyA}[0]{(dom(\rhomap),\rhoenv,\cdot,\phicx)}
\newcommand{\emptyASigp}[0]{(dom(\rhomap'),\rhoenv,\cdot,\phicx)}
\newcommand{\emptyASigpp}[0]{(dom(\rhomap''),\rhoenv,\cdot,\phicx)}
\newcommand{\emptyADelcup}[1]{(dom(\rhomap),\rhoenv \cup \{#1\},\cdot,\phicx)}
\newcommand{\emptyASigpDelcup}[1]{(dom(\rhomap'),\rhoenv \cup \{#1\},
                                    \cdot,\phicx)}
\newcommand{\emptyASigxDelcup}[2]{(dom(\rhomap[#1]),\rhoenv \cup \{#2\},
                                    \cdot,\phicx)}
\newcommand{\emptyADelcupPhicap}[2]{(dom(\rhomap),\rhoenv \cup \{#1\},
                                    \cdot,\phicx \conj \rhoenv \outlives #2)}
\newcommand{\emptyADelcupPhicapp}[2]{(dom(\rhomap),\rhoenv \cup \{#1\},
                                    \cdot,\phicx \conj #2)}
...
\authorinfo{G Ramalingam}
           {Microsoft Research, India}
           {grama@microsoft.com}

\authorinfo{Kapil Vaswani}
           {Microsoft Research, India}
