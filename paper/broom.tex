...
\newcommand{\emptyASigp}[0]{(dom(\rhomap'),\rhoenv,\cdot,true)}
\newcommand{\emptyASigpp}[0]{(dom(\rhomap''),\rhoenv,\cdot,true)}
\newcommand{\emptyADelcup}[1]{(dom(\rhomap),\rhoenv \cup \{#1\},\cdot,true)}
\newcommand{\emptyASigpDelcup}[1]{(dom(\rhomap'),\rhoenv \cup \{#1\},\cdot,true)}
