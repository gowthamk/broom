...
\begin{array}{cr}
  \hspace*{-2in}\forall (\tau_0, \rhoenv_0, \rhomap_0, \phicx_0, \rgn_0). \rgn_0 \in \rhoenv_0 \conj
    \hastyp{(dom(\rhomap_0),\rhoenv_0,\cdot,\phi_0),\rgn_0, \cdot}{e_0}{\tau_0} \Rightarrow& IH1\\
...
%                     {(e',\rhomap')} & IH1\\
  ...
  \begin{array}{cr}
    ...
    \rgn_0 \notin \rhoenv & H9\\
    \hastyp{\emptyADelcup{\rgn_0},\rgn_0,[y \mapsto T@\rgn_0]}{e_b}{\tau} & H11\\
  \end{array}
  \end{smathpar}
  ...
  \begin{array}{cr}
    ...
    \hastyp{\emptyADelcup{\rgn_i},\rgn_i, \cdot}{v}{T@\rgn_i} & H16\\
%   \hastyp{\emptyA,\rgn,
...
% \end{smathpar}
  ...
  \begin{array}{cr}
    ...
    \isvalid{\phicx}{[\rbar/\rhobar][\rgn/\rhoalloc]\phi}
  \end{array}
  \end{smathpar}
  Three cases: 
  \begin{itemize}
...
%     $\rgn_j$ is fresh ($\rgn_j \notin \rhoenv \cup dom(\rhomap)$).
      ...
      \begin{array}{cr}
        ...
        \hastyp{\emptyADelcup{\rgn_i},\rgn_i,\cdot} {e_0}{T@\rgn_i} & H20\\
      \end{array}
      \end{smathpar}
