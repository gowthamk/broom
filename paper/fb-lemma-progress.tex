...
\begin{array}{cr}
  \hspace*{-2in}\forall (\tau_0, \rhoenv_0, \rhomap_0, \rgn_0). \rgn_0 \in \rhoenv_0 \conj
    \hastyp{(dom(\rhomap_0),\rhoenv_0,\cdot,true),\rgn_0, \cdot}{e_0}{\tau_0} \Rightarrow& IH1\\
...
%                     {(e',\rhomap')} & IH1\\
  ...
  \begin{array}{cr}
    ...
    \hastyp{(dom(\rhomap), \rhoenv \cup \{\rgn_i\},\cdot,true),\rgn_i, \cdot}{v}{T@\rgn_i} & H16\\
%   \hastyp{\emptyA,\rgn,
...
% \end{smathpar}
  ...
  \begin{smathpar}
  \begin{array}{cr}
    \hastyp{(dom(\rhomap),\rhoenv \cup \{\rgn_0\},\cdot,true),\rgn_0, \cdot}{[\rgn_0/\rgn_i]v}{T@\rgn_0} & H18\\
  \end{array}
  \end{smathpar}
  ...
  \begin{itemize}
    ...
    \begin{smathpar}
    \begin{array}{cr}
      \hastyp{\emptyA,\rgn, \cdot}{\C{new}\; \RgnZ\inang{T}\inang{\rgn_i}(e_0)}{\tau} & H4\\
    \end{array}
    \end{smathpar}
    ...
    \begin{itemize}
      ...
      \begin{array}{cr}
        ...
        \rgn_i \notin \rhoenv & H18\\
        \hastyp{(dom(\rhomap), \rhoenv \cup \{\rgn_i\},\cdot,true),\rgn_i,\cdot}
              {e_0}{T@\rgn_i} & H20\\
      \end{array}
      \end{smathpar}
