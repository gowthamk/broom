...
%In particular, given a  C\# library
...
% \footnote{We omit \C{@R} annotation in \C{open} when we don't need \C{R}.}
Line 9 creates a stack region \C{R0}.  Thus, the temporary objects created by
...
of \C{selector} in line 12 are allocated in the output region.
