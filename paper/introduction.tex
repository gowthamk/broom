...
have a cascading adverse effect on the performance of other nodes.
For instance, a GC pause at an upstream actor can block
downstream actors that are waiting for messages. 
Much of the GC overhead results from the collector performing avoidable or unproductive work.
