...
The motivating example in Fig.~\ref{fig:motivating-eg} represents
a \C{SELECT} query operator for streaming data. 
...
This example (of  a producer creating a data structure and transferring it to a consumer)
is an instance of a general idiom of a set of concurrent actors interacting via messages
(representing data-structures).
Our focus in this paper is a region-based approach to realizing such transferable
data, motivated by the following concerns.
