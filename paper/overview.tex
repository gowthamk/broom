...
region \C{Ro} that lives just long enough.  We open the desired output
...
Note that this approach works correctly only if \C{selector} creates
...
capturing such nuances in the type of \C{selector} and the type
