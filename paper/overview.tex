...
objects created by the invocation of \C{userDefinedFunction} in line 13
are allocated in the output region.
Finally, the input region is freed in line 19.

Note that this approach works correctly only if \C{userDefinedFunction}
...
capable of capturing such nuances in the type of \C{userDefinedFunction}
