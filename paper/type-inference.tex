...
% the special structure of the generated
...
%% (b) $\satC$ is satisfiable iff $\myground{C}$ is valid.
...
\TODO{The following is an informal sketch, requiring some formalization.}
