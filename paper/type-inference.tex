...
\begin{enumerate}
 \item The first step elaborates the input program by introducing \emph{formal region parameters}
...
%% \end{enumerate}
 ...
 \item In the second step, we analyze the program to generate a set of constraints
