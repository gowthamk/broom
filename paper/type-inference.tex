...
The first step in our algorithm for solving a set of constraints $C$ uses an
iterative fixed point algorithm to compute a $\satC \supseteq C$ of
constraints by adding  a set of constraints that are logically implied by $C$.
% \paragraph{Step 1.}
...
One key point of the first step is that it has the effect of unifying region variables with the
