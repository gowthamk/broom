...
\onecolumn
\include{fb-lemma-substitution}
\include{fb-lemma-renaming}
\include{fb-lemma-tywf}
\include{fb-lemma-progress}
\include{fb-lemma-preservation}
\include{fb-lemma-type-safety}
\twocolumn
