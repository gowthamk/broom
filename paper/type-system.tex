...
\dv{Why do we have the type parameters of $a$ and $b$ extending \C{Object} versus
  the actual class extending \C{Object<$\rho^a$>}? Also, instead of explicitly introducing
