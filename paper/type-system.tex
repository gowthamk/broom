...
polymorphism}.
%
% For instance, a \C{Pair} object allocated in a region ${\rhoalloc}$
% can have its first component coming from ${\rho_1}$ and second from
% $\rho_2$, as long as $\rho_1, \rho_2$ outlive $\rhoalloc$, as
% illustrated by the above definition.
