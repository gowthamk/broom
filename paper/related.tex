...
% Our type inference algorithm is also novel compared to existing type
% inference approaches for ownership types, which are based on, e.g.,
% context-insensitive pointer analysis or boolean satisfiability.
% E.g., papers 55 and 79.

~\cite{HMN01} proposes a flow-sensitive approach for first-order programs
% to overcome some of the drawbacks of~\cite{tofte97}
