...
\item Case ($e = e_0.f_i$): Intros. Hypothesis:
  ...
  \begin{itemize}
    ...
    \begin{smathpar}
    \begin{array}{cr}
      \hastyp{(dom(\rhomap),\rhoenv, \cdot, true), \rgn, \cdot}{v_0}{\tau} & H13\\
    \end{array}
    \end{smathpar}
...
%                     {(e',\rhomap')} & IH1\\
  ...
  \begin{itemize}
    ...
    \begin{smathpar}
    \begin{array}{cr}
      \hastyp{(dom(\rhomap[\rgn_i \mapsto \OPEN]),\rhoenv \cup \{\rgn_0\},
          \cdot,true),\rgn_0, \cdot}{[[\rgn_0/\rgn_i]v_r/y]e_b}{\tau} & H40\\
    \end{array}
    \end{smathpar}
...
%   \end{smathpar}
  ...
  \begin{array}{cr}
    \rgn \in \rhoenv & H2\\
    \hastyp{\emptyA,\rgn, \cdot}{\C{new}\; \RgnZT{\toprgn}(v_0)}{\tau} & H4\\
    \redstoo{(e,\rhomap)}{(e',\rhomap')} & H6\\
  \end{array}
  \end{smathpar}
  Inverting $H4$:
