...
% \newcommand{\SRULE}[2]{\frac{\renewcommand*{\arraystretch}{1.2}\begin{array}{c} #1 \end{array}}{\renewcommand*{\arraystretch}{1.2}\begin{array}{c} #2 \end{array}}}
...
%   \rhoenv' = \rhoenv \cup \{\rhoalloc,\rhobar\}\spc
    ...
    \typeok {\A'} {\tau^2} {C_2} \spc
    \exprok {\A',\env[\xbar \mapsto \bar{\tau^1}]} {e} {\tau^2} {C_3}
  }
  {
    \exprok {\stdcontext}
...
\caption{A subset of the constraint generation rules.}
